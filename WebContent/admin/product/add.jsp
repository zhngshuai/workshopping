...
<body>
	...
	<form id="userAction_save_do" name="Form1"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			bgColor="skyblue" style="border: 1px solid skyblue" border="0">
			<tr>
				<td class="ta_01" align="center" bgColor="skyblue" colSpan="4"
					height="26"><strong><STRONG>添加商品</STRONG> </strong></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="skyblue" class="ta_01">
					商品名称：</td>
				<td class="ta_01" bgColor="skyblue"><input type="text"
			...
			<tr>
				<td width="18%" align="center" bgColor="skyblue" class="ta_01">
					商品图片：</td>
				<td class="ta_01" bgColor="skyblue" colspan="3">
					<input type="file" name="upload"/></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="skyblue" class="ta_01">
					所属的二级分类：</td>
				<td class="ta_01" bgColor="skyblue" colspan="3"><select
					name="csid">
